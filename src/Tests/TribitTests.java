...
public class TribitTests {
    ...
    public static List testStrings() {
        return Arrays.asList(new Object[][]{
                ...
                {"0000111100001111", "1"}, //19
                {"0110100101101001", "0"}, //20
                {"0110110000110110", "1"}, //21
                {"1001100110011001", "0"}, //22
                {"1110111100111000", "0"}, // Test from description. Description lies.
                {"1111011001001010011001101101010100011010111010011111011001011101", "1"}, // Test on strings with length 64.
                {"1100100100001111110110101010001000100001011010001100001000110100", "0"}  // Final description test. Description lies.
        });
    }
